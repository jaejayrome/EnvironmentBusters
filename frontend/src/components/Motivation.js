            ...
            <Box className="flex flex-col sm:flex-row"> 
                ...
                <Box className="mx-auto py-5 text-center"> 
                    ...
                    <div className="flex flex-col text-left space-y-8 px-4 mt-4 sm:mt-0 sm:px-0"> 
                        ...
                        <motion.div ref = {ref} variants = {animationVariants} animate = {inView ? "visible" : "hidden"} initial = "hidden" transition = {{duration: 0.3}}>
                        ...
                        <motion.div ref = {ref} variants = {animationVariants} animate = {inView ? "visible" : "hidden"} initial = "hidden" transition = {{duration: 0.5, delay: 0.25}}>
                        ...
                        <motion.div ref = {ref} variants = {animationVariants} animate = {inView ? "visible" : "hidden"} initial = "hidden" transition = {{duration: 0.5, delay: 0.5}}>
                        ...
                        <motion.div ref = {ref} variants = {animationVariants} animate = {inView ? "visible" : "hidden"} initial = "hidden" transition = {{duration: 0.5, delay: 0.75}}>
